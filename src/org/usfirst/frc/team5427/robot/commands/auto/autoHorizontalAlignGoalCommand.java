...
/**
 * this class uses the number from the networkTable to move the robot left or
 * right. It is set on a timer. This command should be called from AutoDrive
 */
...
//		NetworkTable.setIPAddress("localhost");
	...
	/**
	 * returns direction the robot needs to turn, based on data input fromt the
	 * NetworkTable
	 */
