...
//	public Button flapClose = new JoystickButton(joy, Config.FLAP_CLOSE);
	...
	public Button intake = new JoystickButton(joy, Config.START_INTAKE_BUTTON);

	public Button intakeOut = new JoystickButton(joy, Config.OUT_INTAKE_BUTTON);
	...
	public OI() {
		...
		intake.whenPressed(new SetIntakeSpeed(Config.INTAKE_MOTOR_SPEED));
		intakeOut.whenPressed(new SetIntakeSpeed(Config.OUT_INTAKE_BUTTON));
