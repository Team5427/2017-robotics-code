...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		// c.start();
		// if (c.isConnected())
		// Log.init("Connection successfully established with the driver
		// station.");
		// else
		// Log.init("Connection failed to establish. Client will continue to
		// connect with the driver station.");
		// } catch (Exception e) {
